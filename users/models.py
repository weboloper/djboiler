...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    groups = models.ManyToManyField(
        'auth.Group',
        related_name='myuser_set',  # Add a unique related_name for the my user model
        blank=True,
    )
    user_permissions = models.ManyToManyField(
        'auth.Permission',
        related_name='myuser_permissions_set',  # Add a unique related_name for the my user model
        blank=True,
    )
